...
@dp.message_handler(commands=['_santa'], state=None)
...
@dp.message_handler(commands=['_end'])
...
Именно это ты скоро услышишь в офисе профкома, который ты указал в форме регистрации, ведь твой Тайный Санта уже оставил там подарок!
